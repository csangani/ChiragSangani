<div class="ContentWrapper YellowBackground ContentTop">
    <div class="Content clearfix">
        <div class="Full">
            <div class="XXL SemiBold AllCaps" style="margin:0 0 40px 0;">Shad</div>
            <iframe style="z-index:99" width="998" height="561" src="//www.youtube-nocookie.com/embed/49pXTvv0zw0" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
</div>
<div class="ContentWrapper" style="background:url('<?= $assetRoot ?>images/shad/screen1.png') center center no-repeat;height:900px;">
</div>
<div class="ContentWrapper DarkBackground">
    <div class="Content clearfix">
        <div class="Full">
            <div class="XL SemiLight">Shad is a fun, platform-style 3D game.</div>
            <p class="M">I made Shad with four other very talented people as part of the Interactive Graphics course at Stanford. We were the runners-up at Stanford's annual game design competition.</p>
        </div>
    </div>
</div>
<div class="ContentWrapper WhiteBackground">
    <div class="Content clearfix">
        <div class="Full">
            <div class="XXL SemiLight">Physics</div>
            <p class="M">Shad features complex physics simulation.</p>
        </div>
    </div>
    <div class="Content clearfix">
...
<div class="ContentWrapper DarkGrayBackground">
    <div class="Content clearfix">
        <div class="Full">
            <div class="XXL SemiLight">Art
                <p class="M">Shad features striking custom art and psychedelic effects, accompanied by a custom soundtrack.</p>
            </div>
        </div>
    </div>
    <div class="Content clearfix">
