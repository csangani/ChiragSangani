...
<title>Aryans | Teams | Galaxy '10 | IIT Kanpur</title>
...
<div id="loading" style="left: 0px; top: 3px">
	<p>loading</p>
	<noscript>
			...
			<div id="header-right">
				<div id="time-wrapper">
					...
					<div id="theme-wrapper">
						<a id="light" title="Light" class="theme-select" href="<?php $url = explode('?',$_SERVER['REQUEST_URI']); echo $url[0] ?>?theme=light"></a>
						<a id="dark" title="Dark" class="theme-select" href="<?php $url = explode('?',$_SERVER['REQUEST_URI']); echo $url[0] ?>?theme=dark"></a>
						<a id="auto" title="Auto" class="theme-select" href="<?php $url = explode('?',$_SERVER['REQUEST_URI']); echo $url[0] ?>"></a></div>
				</div>
			</div>
			<div class="header-tab">
